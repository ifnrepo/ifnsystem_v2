...
But that's the difference in our opinions.</textarea>
    ...
    <!-- Libs JS -->
    <script src="<?= base_url('assets'); ?>/dist/libs/nouislider/dist/nouislider.min.js?1692870487" defer></script>
    <script src="<?= base_url('assets'); ?>/dist/libs/litepicker/dist/litepicker.js?1692870487" defer></script>
    <script src="<?= base_url('assets'); ?>/dist/libs/tom-select/dist/js/tom-select.base.min.js?1692870487" defer></script>
    <!-- Tabler Core -->
